      ...
      <nav role="navigation" class="navbar topnavbar">
        ...
        <div class="container">
            <form class="form-signin" role="form">
              ...
              <input id="email" class="form-control" type="email" placeholder="Usuario" required autofocus>
              <input id="password" class="form-control" type="password" placeholder="Clave" required>
              <button class="btn btn-lg btn-primary btn-block" type="submit" id="login_button">Acceder</button>
              <br><br>
